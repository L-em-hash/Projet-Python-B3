...
![Status](https://img.shields.io/badge/statut-termin%C3%A9-green)
![Projet](https://img.shields.io/badge/projet-acad%C3%A9mique-blueviolet)
...
* **Obtention des données Internet** : Téléchargement dynamique de données via une API web au format JSON.
...
* **Menu contextuel** : Menu supérieur permettant d'effacer le contenu de la base, d'exécuter des actions ou de personnaliser les thèmes d'affichage (Clair / Sombre).
...
Le projet adopte une structure modulaire stricte, séparant la logique métier (`src/`), l'interface utilisateur et les modules de tests automatiques (`tests/`) :
...
│   └── graphique_bdd.png       # Graphiques exportés temporaires
│
├── src/                        # Code source de l'application
│   ├── __init__.py             # Initialisation du paquet src
...
│   ├── __init__.py             # Initialisation du paquet tests
